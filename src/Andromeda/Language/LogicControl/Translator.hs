...
module Andromeda.Language.LogicControl.Translator where
...
printCreated (CreatedConstr a) = print' "Created Constr "
printCreated (CreatedControllerScript a) = print' "Created Constr Script "
